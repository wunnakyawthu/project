...
//          echo "<h4>".$_SESSION['message']."</h4>";
    ...
    <h3 class="mt-4 mb-4 text-primary">
        <a href="add-new.php" class="btn btn-dark"><i class="fa-solid fa-plus me-2"></i>Add New</a>
        <a class="badge bg-danger text-white rounded">
               <?php
               $statement = "SELECT * FROM `crud`";
               $all = mysqli_query($conn, $statement);
               $count = $all->fetch_all();
               ?>
               <?= count($count) ?>
			</a>
