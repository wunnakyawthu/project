...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `crud` SET `Incident_Type`='$Incident_Type',`Fault_owner`='$Fault_owner',`Fault_occur_at`='$Fault_occur_at',`Trouble_Name`='$Trouble_Name',`Resolution`='$Resolution',`Start`='$Start',`End`='$End',`Duration`='$Duration' WHERE `id`='$id'";

  $result = mysqli_query($conn, $sql);

    if ($result) {
        $_SESSION['message'] = "ID : $id Edit Successfully";
          ...
          <form action="" method="post" style="width:50vw; min-width:300px;">
              <div class="row mb-3">
                  <div class="col">
                      ...
                      <input type="text" class="form-control" name="Incident_Type" value="<?php echo $row['Incident_Type'] ?>">
                  </div>

                  <div class="col">
                      <label class="form-label">Fault owner:</label>
                      <input type="text" class="form-control" name="Fault_owner" value="<?php echo $row['Fault_owner'] ?>">
                  </div>
                  <div class="col">
                      <label class="form-label">Fault occur at:</label>
                      <input type="text" class="form-control" name="Fault_occur_at" value="<?php echo $row['Fault_occur_at'] ?>">
                  </div>
              </div>
              ...
              <div class="mb-3">
                  ...
                  <textarea type="text" name="Trouble_Name" class="form-control" row="6" cols="100" ><?php echo $row['Trouble_Name'] ?></textarea>
              ...
              <div class="mb-3">
                  ...
                  <textarea type="text" name="Resolution" class="form-control" row="6" cols="100"><?php echo $row['Resolution'] ?></textarea>
              </div>
              <div class="row mb-3">
                  <div class="col">
